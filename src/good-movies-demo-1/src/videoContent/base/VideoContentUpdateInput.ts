...
class VideoContentUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => GenreUpdateManyWithoutVideoContentsInput,
  })
  @ValidateNested()
  @Type(() => GenreUpdateManyWithoutVideoContentsInput)
  @IsOptional()
  @Field(() => GenreUpdateManyWithoutVideoContentsInput, {
    nullable: true,
  })
...
export { VideoContentUpdateInput as VideoContentUpdateInput };
